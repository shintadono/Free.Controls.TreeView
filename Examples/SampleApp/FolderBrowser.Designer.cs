namespace SampleApp
{
    partial class FolderBrowser
    {
        ...
        private void InitializeComponent()
        {
			...
			this._treeView = new Free.Controls.TreeView.Tree.TreeViewAdv();
			...
			this.nodeCheckBox1 = new Free.Controls.TreeView.Tree.NodeControls.NodeCheckBox();
			this._icon = new Free.Controls.TreeView.Tree.NodeControls.NodeStateIcon();
			this._name = new Free.Controls.TreeView.Tree.NodeControls.NodeTextBox();
			this._size = new Free.Controls.TreeView.Tree.NodeControls.NodeTextBox();
			this._date = new Free.Controls.TreeView.Tree.NodeControls.NodeTextBox();
			this.SuspendLayout();
			// 
			// cboxGrid
			// 
			...
			this._treeView.GridLineStyle = ((Free.Controls.TreeView.Tree.GridLineStyle)((Free.Controls.TreeView.Tree.GridLineStyle.Horizontal | Free.Controls.TreeView.Tree.GridLineStyle.Vertical)));
			...
			this._treeView.NodeMouseDoubleClick += new System.EventHandler<Free.Controls.TreeView.Tree.TreeNodeAdvMouseEventArgs>(this._treeView_NodeMouseDoubleClick);
			this._treeView.ColumnClicked += new System.EventHandler<Free.Controls.TreeView.Tree.TreeColumnEventArgs>(this._treeView_ColumnClicked);
		...
		private Free.Controls.TreeView.Tree.TreeViewAdv _treeView;
		private Free.Controls.TreeView.Tree.NodeControls.NodeStateIcon _icon;
		private Free.Controls.TreeView.Tree.NodeControls.NodeTextBox _name;
		private Free.Controls.TreeView.Tree.NodeControls.NodeTextBox _size;
		private Free.Controls.TreeView.Tree.NodeControls.NodeTextBox _date;
		private Free.Controls.TreeView.Tree.NodeControls.NodeCheckBox nodeCheckBox1;
