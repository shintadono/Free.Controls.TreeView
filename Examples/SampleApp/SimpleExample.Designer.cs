namespace SampleApp
{
	partial class SimpleExample
	{
		...
		private void InitializeComponent()
		{
			...
			this._tree2 = new Free.Controls.TreeView.Tree.TreeViewAdv();
			this.nodeTextBox1 = new Free.Controls.TreeView.Tree.NodeControls.NodeTextBox();
			this._tree = new Free.Controls.TreeView.Tree.TreeViewAdv();
			this._nodeCheckBox = new Free.Controls.TreeView.Tree.NodeControls.NodeCheckBox();
			this._nodeStateIcon = new Free.Controls.TreeView.Tree.NodeControls.NodeStateIcon();
			this._nodeTextBox = new Free.Controls.TreeView.Tree.NodeControls.NodeTextBox();
			...
			this._addRoot.Click += new System.EventHandler(this._addRoot_Click);
			// 
			// _clear
			// 
			...
			this._tree.SelectionMode = Free.Controls.TreeView.Tree.TreeSelectionMode.MultiSameParent;
			...
			this._nodeStateIcon.ScaleMode = Free.Controls.TreeView.Tree.ImageScaleMode.Clip;
			// 
			// _nodeTextBox
			// 
		...
		private Free.Controls.TreeView.Tree.TreeViewAdv _tree;
		private System.Windows.Forms.Button _addRoot;
		private System.Windows.Forms.Button _clear;
		private Free.Controls.TreeView.Tree.NodeControls.NodeCheckBox _nodeCheckBox;
		private System.Windows.Forms.Button _addChild;
		private System.Windows.Forms.Button _deleteNode;
		private Free.Controls.TreeView.Tree.NodeControls.NodeStateIcon _nodeStateIcon;
		private Free.Controls.TreeView.Tree.NodeControls.NodeTextBox _nodeTextBox;
		...
		private Free.Controls.TreeView.Tree.TreeViewAdv _tree2;
		private Free.Controls.TreeView.Tree.NodeControls.NodeTextBox nodeTextBox1;
