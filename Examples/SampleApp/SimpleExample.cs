...
using Free.Controls.TreeView.Tree;
...
namespace SampleApp
{
	public partial class SimpleExample : UserControl
	{
		...
		private Node AddRoot()
		{
			...
			Node node=new Node("Long Root Node Text"+_model.Nodes.Count.ToString());
		...
		private void _addRoot_Click(object sender, EventArgs e)
		{
			AddRoot();
		}
