...
namespace Free.Controls.TreeView.Tree.NodeControls
{
	...
	{
		public const int ImageSizeX=32;
		public const int ImageSizeY=32;
		...
		{
			_check=Free.Controls.TreeView.Properties.Resources.check;
			_uncheck=Free.Controls.TreeView.Properties.Resources.uncheck;
			_unknown=Free.Controls.TreeView.Properties.Resources.unknown;
		...
		{
			return new Size(ImageSizeX+2, ImageSizeY+2);
		}
		...
		{
			if(state==CheckState.Indeterminate) return CheckState.Unchecked;
			else if(state==CheckState.Unchecked) return CheckState.Checked;
			else return ThreeState?CheckState.Indeterminate:CheckState.Unchecked;
		}
		...
		{
			if(CheckStateChanged!=null) CheckStateChanged(this, args);
		}
