...
namespace Free.Controls.TreeView.Tree.NodeControls
{
	public class NodeStateIcon : NodeIcon
	{
		...
		{
			_leaf=MakeTransparent(Free.Controls.TreeView.Properties.Resources.Leaf);
			_opened=MakeTransparent(Free.Controls.TreeView.Properties.Resources.Folder);
			_closed=MakeTransparent(Free.Controls.TreeView.Properties.Resources.FolderClosed);
		}
